...
export default [
	{
		...
		rules: {
			...
			"no-restricted-imports": [
				...
				{
					paths: [
						{ name: "fs", message: "Node `fs` is unavailable on the Workers runtime." },
						{ name: "path", message: "Node `path` is unavailable on the Workers runtime." },
						{ name: "os", message: "Node `os` is unavailable on the Workers runtime." },
						{
							name: "child_process",
							message: "Node `child_process` is unavailable on the Workers runtime.",
						},
					],
				},
			],
